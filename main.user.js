// ==UserScript==
// @name         VodkaBot
// @namespace    https://github.com/almightyslab
// @version      v3.0public
// @license      GPLv3
// @description  A bot for pixelplace.io
// @author       Vodka
// @match        https://pixelplace.io/*
// @icon         https://i.superhaber.tv/storage/files/images/2019/12/25/ffff-u5JJ.jpg
...
if (localStorage.firstTime == undefined) {
  ...
  toastr.warning(
    "Welcome to VodkaBot. Vodka bot is improved version of bababot",
    { timeOut: 9500 }
  );
}
...
console.log("%cVodkabot.bread yüklendi. Vodka tarafından yapılmıştır (improved of bababot)", "font-family: system-ui");
const Palette = {
  order: [
...
let bababot = $(
  '<a target="_blank" href="discord.io/vodkabaslar">VodkaBot</a>'
).css({
  display: "block",
  position: "absolute",
  width: "auto",
...
let elem = $(
  '<a href="#" title="VodkaBot" class="grey margin-top-button"><img src="https://img.icons8.com/ios-glyphs/344/ffffff/martini-glass.png" alt="icon"></a>'
);
...
function createGraphWindow() {
  ...
  var data = {
    ...
    datasets: [
      {
        label: "Pixels per second botted by VodkaBot",
